<div align="center">
  ...
  <img src="doc/assets/logo.png" alt="BondBase Logo" width="140" style="border-radius: 24px; margin-bottom: 12px;" />

  # ⚡ BondBase — Social Media & Community Platform

  **A modern, full-stack Instagram-inspired social platform engineered for real-time connection, story sharing, interactive feeds, and deep community engagement.**
  ...
  <img src="doc/assets/banner.png" alt="BondBase Hero Banner" width="100%" style="border-radius: 12px; margin-top: 10px; margin-bottom: 20px;" />
...
**BondBase** reimagines the social networking experience with a sleek **Midnight Violet** glassmorphism aesthetic, lightning-fast real-time messaging via Socket.io, expressive 24-hour stories, post engagement analytics, and deep creator discovery tools.

Whether you're sharing high-res media, catching up with friends in real-time direct messages, or analyzing your post reach, **BondBase** provides an end-to-end, responsive web app experience on mobile and desktop.
...
| ⭕ **24-Hour Stories** | Ephemeral multimedia story reels. | Segment progress bar animations, viewer analytics lists, and instant emoji quick-reactions. |
| 💬 **Real-Time Messaging** | Low-latency chat engine powered by WebSockets (`Socket.io`). | Online/offline presence indicators, live typing indicators, delivery/read receipts (`Sent ✓`, `Delivered ✓✓`, `Seen ✓✓`), image attachments, and message reactions. |
...
- **Styling**: Modern Vanilla CSS with CSS Variables, Flexbox/Grid, Glassmorphism, Custom Keyframe Animations
- **Icons**: `lucide-react`
...
```bash
git clone https://github.com/anuragsinghrajput123456789/Instagram-Clone.git
cd Instagram-Clone
```
...
MONGO_URI=mongodb+srv://<username>:<password>@cluster.mongodb.net/bondbase
...
Feel free to check the [issues page](https://github.com/anuragsinghrajput123456789/Instagram-Clone/issues) if you want to contribute.
